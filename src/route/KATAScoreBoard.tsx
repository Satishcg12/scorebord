...
const KATAScoreBoard = () => {
  const { division, kata,  name,  numberOfJudges,  scores,  tatami,  largestScoreIndex, showScores, smallestScoreIndex } = useKataScoreStore((state) => state)
  ...
  return (
    <div className="bg-black text-white h-screen w-screen p-4 text-4xl uppercase relative">
      ...
      <fieldset className="border-white border-8 h-full grid grid-rows-3">
        <legend className="font-mono font-bold text-5xl ml-4">{tatami}</legend>
        ...
        <div className="grid grid-cols-4 grid-rows-4 gap-2">
          <div className="row-span-3 bg-red-500 px-4 p-2 text-5xl grid place-items-center text-[20vh] font-digital-display">
