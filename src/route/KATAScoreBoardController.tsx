...
const KATAScoreBoardController = () => {
  ...
  const { division, setDivision, kata, setKata, name, setName, numberOfJudges, setNumberOfJudges, scores, setScores, tatami, setTatami,largestScoreIndex,reset,showScores,smallestScoreIndex,toggleShowScores } = useKataScoreStore((state) => state)
